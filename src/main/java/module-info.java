...
module tools.jackson.core {
    ...
    opens tools.jackson.core to tools.jackson.core.unittest;
    opens tools.jackson.core.async to tools.jackson.core.unittest;
    opens tools.jackson.core.base to tools.jackson.core.unittest;
    opens tools.jackson.core.exc to tools.jackson.core.unittest;
    opens tools.jackson.core.filter to tools.jackson.core.unittest;
    opens tools.jackson.core.io to tools.jackson.core.unittest;
    ...
    opens tools.jackson.core.json.async to tools.jackson.core.unittest;
    opens tools.jackson.core.sym to tools.jackson.core.unittest;
    opens tools.jackson.core.tree to tools.jackson.core.unittest;
    opens tools.jackson.core.type to tools.jackson.core.unittest;
    opens tools.jackson.core.util to tools.jackson.core.unittest;
