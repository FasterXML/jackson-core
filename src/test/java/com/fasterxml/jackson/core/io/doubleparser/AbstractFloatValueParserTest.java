...
public abstract class AbstractFloatValueParserTest {
    ...
    protected List<TestData> createDataForSignificandDigitsInputClasses() {
        return Arrays.asList(
                // In the worst case, we must consider up to 768 digits in the significand
                new TestData("Round Down due to value in 768-th digit",
                ...
                new TestData("Round Up due to value in 768-th digit ",
