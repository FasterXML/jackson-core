...
class CustomEscaping1668Test extends com.fasterxml.jackson.core.JUnit5TestBase
{
    ...
    private final JsonFactory JSON_F = new JsonFactoryBuilder()
    ...
    void zeroLengthEscapeAtBufferBoundaryChars() throws Exception
    {
        for (int pad = 3900; pad <= 4100; ++pad) {
            ...
            try (JsonGenerator g = JSON_F.createGenerator(w)) {
                _writeDoc(g, pad);
            }
