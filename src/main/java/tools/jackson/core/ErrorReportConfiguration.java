    ...
    implements Serializable
{
    ...
    /**
     * Override the default ErrorReportConfiguration. These defaults are only used when {@code JsonFactory}
     ...
     * lib should create <code>ObjectMapper</code> instances that have a {@code JsonFactory} instance with
    ...
    /**
     * @return the default {@link ErrorReportConfiguration} (when none is set on the {@code JsonFactory} explicitly)
